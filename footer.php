		...
		<div class="container">
			<div class="row">
				<div class="col-md-4"><!--footer twitter widget-->
					...
					<a href="#" class="btn btn-default btn-follow"><i class="fa fa-twitter fa-2x"></i><div>Bizleri Twitterden Takip Edin</div></a>
				</div><!--footer twitter widget-->
				<div class="col-md-4"><!--footer newsletter widget-->
					<div class="title-widget-bg">
						<div class="title-widget">Abone Olun</div>
					</div>
					<div class="newsletter">
						<p>
							Abone olmak artık daha kolay.
						</p>
						<form role="form">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						...
						<li class="fmail"><?php echo $ayarcek['ayar_mail']; ?></li>
						<li class=""><?php echo $ayarcek['ayar_il']; ?> <br><?php echo $ayarcek['ayar_ilce']; ?></li>
						<li class=""><?php echo $ayarcek['ayar_adres']; ?></li>
						<li class=""><?php echo $ayarcek['ayar_mesai']; ?></li>
					</ul>
			...
			<div class="row">
				<div class="col-md-9">
					<ul class="footermenu"><!--footer nav-->
						...
						<li><a href="index.php">Bize Ulaşın</a></li>
					</ul><!--footer nav-->
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'] ?> <a href="http://222.joyakademi.com">www.softwarEngineer.com</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					<div class="followon">Bizleri Takip Ediniz...</div>
					<div class="fsoc">
