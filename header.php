        ...
        <div class="pushright">
         <div class="top">
           ...
           <?php } else { ?>
             ...
             <!--
             <div class="col-xs-6 col-md-4 main-logo">
               <a href="index.php"><img width="100" src="<?php echo $kullanici['kullanici_resim'] ?>" alt="Kullanıcı Logosu" class="logo img-responsive"></a>
             </div>
           -->
           ...
           <div class="row">
            ...
            <form action="nedmin/netting/islem.php" method="POST" role="form">
             ...
             <div class="form-group">
               ...
               <button type="submit" name="kullanicigiris" class="btn btn-default btn-red btn-sm">Şifremi Unuttum</button>
             </div>
      ...
      <div class="col-md-12">
       <form action="arama.php" method="POST" class="form-horizontal" role="form">
        <div class="form-group">
         ...
         <button class="btn btn search" name="arama">ARA</button>
         <div class="col-sm-10">
...
<div class="main-nav"><!--end main-nav -->
 <div class="navbar navbar-default navbar-static-top">
  ...
  <div class="col-md-2 machart">
   <button id="popcart" class="btn btn-default btn-chart btn-sm "><span class="mychart">SEPETİM</span>|<!--<span class="allprice">$0.00</span>--></button>
   <div class="popcart">
    ...
    <table class="table table-condensed popcart-inner">
     ...
     <tbody>
      ...
      while ($sepetcek=$sepetsor->fetch(PDO::FETCH_ASSOC)) {
        ...
        <tr>
         <td>
          <a href="urun-<?=seo($uruncek["urun_ad"]).'-'.$uruncek["urun_id"]?>"><img src="images\dummy-1.png" alt="" class="img-responsive"></a>
        </td>

        <td><a href="urun-<?=seo($uruncek["urun_ad"]).'-'.$uruncek["urun_id"]?>"><?php echo $uruncek['urun_ad'] ?></a><br><span><?php echo $sepetcek['urun_renk'] ?></span></td>
        <td><?php echo $sepetcek['urun_adet'] ?> ADET <br><br></td> 
        <td><p style="color: red;"><?php echo $uruncek['urun_fiyat'] * $sepetcek['urun_adet'] ?> TL</p></td>
...
<span class="sub-tot">Ara Toplam : <span><?php echo $toplam_fiyat  ?></span> | <span>KDV (18%)</span> :<?php echo $kdv ?></span>
<br>
<div class="btn-popcart">
 <a href="kategoriler.php" class="btn btn-default btn-red btn-sm">Ürün Ekle</a>
 <a href="sepet.php" class="btn btn-default btn-red btn-sm">Sepet Detayı</a>
</div>
<div class="popcart-tot">
 <b><p style="color: red;">
  SEPET TUTARI<br>
  <span><?php echo $toplam_fiyat+$kdv ?> TL</span>
</p></b>
</div>
