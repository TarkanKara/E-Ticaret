            ...
            <!-- Resim yükleme formu 
              <form action="../netting/islem.php" method="POST" enctype="multipart/form-data"  data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kullanıcı Logo<br><span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 col-xs-12">

                    <?php 
                    if (strlen($kullanici['kullanici_resim'])>0) {?>

                    <img width="200"  src="../../<?php echo $kullanici['kullanici_resim']; ?>">

                    <?php } else {?>


                    <img width="200"  src="../../dimg/kullanici_logo/24826DSC_2707 ">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="file" id="first-name"  name="kullanici_logo"  class="form-control col-md-7 col-xs-12">
                  </div>
                </div>

                <input type="hidden" name="eski_yol" value="<?php echo $kullanici['kullanici_resim']; ?>">

                <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <button type="submit" name="kullanicilogoduzenle" class="btn btn-primary">Güncelle</button>
                </div>
